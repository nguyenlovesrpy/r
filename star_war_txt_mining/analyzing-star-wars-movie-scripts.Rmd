...
setwd("C:/Users/DellPC/Desktop/txt_mining")
# Read the data
ep4 <- read.table("SW_EpisodeIV.txt",sep="")
ep5 <- read.table("SW_EpisodeV.txt",sep="")
ep6 <- read.table("SW_EpisodeVI.txt",sep="")
```
...
figPath<-"C:/Users/DellPC/Desktop/txt_mining/vader.png"
wordcloud2(frequentTerms(ep4$dialogue), size=0.5,figPath=figPath)
...
wordcloud2(frequentTerms(ep5$dialogue), size=0.5,
           figPath="wordcloud_masks/yoda.png")
```
...
wordcloud2(frequentTerms(ep6$dialogue), size=0.5,
           figPath="wordcloud_masks/r2d2.png")
```
...
wordcloud2(frequentTerms(trilogy$dialogue), size=0.4)
           figPath="wordcloud_masks/rebel alliance.png")
```
