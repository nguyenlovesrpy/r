...
scores<- map(scores,log10)


chartJSRadar(scores,labs = labs,width=1000,height=1000,main="The brief 4 variables for each Group, Profit_Group1 is negative",showToolTipLabel = TRUE,showLegend = TRUE,maxScale = 4,responsive = TRUE,polyAlpha = 0.1)
